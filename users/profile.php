...
<div class="form-group">
    ...
    value="<?php echo htmlentities($row['state'] ?? ''); ?>" class="form-control">
    </div>
    <label class="col-sm-2 col-sm-2 control-label">Country</label>
    <div class="col-sm-4">
    <input type="text" name="country" required="required" 
    value="<?php echo htmlentities($row['country'] ?? ''); ?>" class="form-control">    </div>
</div>
<div class="form-group">
    <label class="col-sm-2 col-sm-2 control-label">Pincode</label>
    <div class="col-sm-4">
    <input type="text" name="pincode" required="required" 
    value="<?php echo htmlentities($row['pincode'] ?? ''); ?>" class="form-control">    </div>
</div>
